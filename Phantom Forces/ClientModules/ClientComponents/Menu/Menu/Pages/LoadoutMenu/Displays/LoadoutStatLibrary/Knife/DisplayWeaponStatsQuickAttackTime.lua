...
return function(p1, p2, p3)
	...
	v2.TextFrameStat.Text = string.upper("Quick Attack Time");
	v2.TextFrameValue.Text = string.upper(u1.oneDecimal(u1.getAnimationTime(p2.animations.quickstab)) .. " seconds");
	return v2;
end;
