...
MenuGroup:AddLabel('Menu bind'):AddKeyPicker('MenuKeybind', { Default = '', NoUI = false, Text = 'Mefqwefqewfewfewnu keybind' }) 
MenuGroup:AddToggle('InterfaceWatermark', {Text = 'Watermark', Default = true}):AddColorPicker('ColorWatermark', {Default = Color3.fromRGB(0, 140, 255), Title = 'Watermark Color'})
...
Library:Notify("!!! IMPORTANT !!!\nIf you see any issues report\nthem to office#6989!", 50, true)
Library:Notify("HI GUYS I LOVE PEOPLE\nTESTESTESTSE ewwefwqef", 2, false)